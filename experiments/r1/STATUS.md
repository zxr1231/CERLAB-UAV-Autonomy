...
Resume from R1-06. Do not repeat R1-01 through R1-05 unless validation fails or the
schema changes. R1-05 is enough for a pilot H1 decision, but remains one correlated run
in one layout and is not formal multi-scene evidence.
